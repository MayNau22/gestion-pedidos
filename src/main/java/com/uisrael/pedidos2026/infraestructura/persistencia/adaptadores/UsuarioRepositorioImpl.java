...
public class UsuarioRepositorioImpl implements IUsuarioRepositorio {
    ...
    public Usuario guardar(Usuario nuevoUsuario) {
        UsuariosEntity entity = mapToEntity(nuevoUsuario);
        UsuariosEntity guardado = usuarioJpaRepositorio.save(entity);
    ...
    private UsuariosEntity mapToEntity(Usuario dominio) {
    ...
    private Usuario mapToDomain(UsuariosEntity entity) {
        return new Usuario(
            entity.getIdUsuario(),
            entity.getCedula(),
            entity.getNombre(),
