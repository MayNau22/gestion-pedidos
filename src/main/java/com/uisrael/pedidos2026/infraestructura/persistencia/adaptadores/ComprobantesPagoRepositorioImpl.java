...
@Repository
public class ComprobantesPagoRepositorioImpl
        implements IComprobantesPagoRepositorio {
    ...
    public ComprobantesPagoRepositorioImpl(
            IComprobantesPagoJpaRepositorio jpaRepositorio,
            IComprobantesPagoJpaMapper entityMapper,
            IPedidosJpaRepositorios pedidosJpaRepositorio,
    ...
    @Override
    public ComprobantesPago guardar(
            ComprobantesPago nuevoComprobante) {

        ComprobantesPagoEntity entity =
                entityMapper.toEntity(nuevoComprobante);

        ComprobantesPagoEntity guardado =
    ...
    @Override
    public Optional<ComprobantesPago> buscarPorId(
            int idComprobante) {
    ...
    @Override
    public Optional<ComprobantesPago> buscarPorPedido(
            int idPedido) {

        return jpaRepositorio
                .findFirstByPedidoComprobanteIdPedidoOrderByFechaSubidaDesc(
                        idPedido
                )
                .map(entityMapper::toDomain);
    }
    ...
    @Override
    public ComprobantesPago guardarArchivo(
            int idPedido,
        ...
        try {
            ...
            EstadosGeneralesEntity estado =
                    estadosJpaRepositorio
                            .findByNombreIgnoreCaseAndTipoEstadoIgnoreCase(
                                    "PENDIENTE",
                                    "COMPROBANTE"
                            )
                            .orElseThrow(() ->
