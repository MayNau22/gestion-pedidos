...
public class PedidosRepositoriosImpl implements IPedidosRepositorio {
	...
	private final IPedidosJpaRepositorios jpaRepositorio;
	private final IPedidosJpaMapper entityMapper;
	
	public PedidosRepositoriosImpl(IPedidosJpaRepositorios jpaRepositorio, IPedidosJpaMapper entityMapper) {
		super();
	...
	public Pedidos guardar(Pedidos nuevopedido) {
		...
		PedidosEntity entity=entityMapper.toEntity(nuevopedido);
